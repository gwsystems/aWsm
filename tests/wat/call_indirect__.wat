...
(module
	...
	(func $type-i32 (export "type-i32") (result i32)
		(call_indirect (type $out-i32) (i32.const 0))
	)

	(func $type-i64 (export "type-i64") (result i64)
		(call_indirect (type $out-i64) (i32.const 1))
	)
	
	(func $type-f32 (export "type-f32") (result f32)
		(call_indirect (type $out-f32) (i32.const 2))
	)

	(func $type-f64 (export "type-f64") (result f64)
	...
	(func $type-index (export "type-index") (result i64)
		(call_indirect (type $over-i64) (i64.const 100) (i32.const 5))
	)

	(func $type-first-i32 (export "type-first-i32") (result i32)
		(call_indirect (type $over-i32) (i32.const 32) (i32.const 4))
	)

	(func $type-first-i64 (export "type-first-i64") (result i64)
		(call_indirect (type $over-i64) (i64.const 64) (i32.const 5))
	)

	(func $type-first-f32 (export "type-first-f32") (result f32)
		(call_indirect (type $over-f32) (f32.const 1.32) (i32.const 6))
	)
	
	(func $type-first-f64 (export "type-first-f64") (result f64)
	...
	(func $dispatch-structural-i64 (export "dispatch-structural-i64") (param i32) (result i64)
		(call_indirect (type $over-i64-duplicate) (i64.const 9) (local.get 0))
	)
	(func $dispatch-structural-i32 (export "dispatch-structural-i32") (param i32) (result i32)
		(call_indirect (type $over-i32-duplicate) (i32.const 9) (local.get 0))
	)
	(func $dispatch-structural-f32 (export "dispatch-structural-f32") (param i32) (result f32)
		(call_indirect (type $over-f32-duplicate) (f32.const 9.0) (local.get 0))
	)
	(func $dispatch-structural-f64 (export "dispatch-structural-f64") (param i32) (result f64)
	...
	(func $as-br_if-first (export "as-br_if-first") (result i64)
	...
	(func $as-br_table-first (export "as-br_table-first") (result f32)
	...
	(func $_start (export "_start")
		...
		;; (assert_return (call $type-f64-i32) (f64.const 0xf64) (i32.const 32))
		
		(if (i64.ne (call $type-index) (i64.const 100)) (then     
			(call $proc_exit (i32.const 2))
		))
		...
		;; These tests seem to test that 
		;; (type $over-i64 (func (param i64) (result i64)))
		;; (if (i64.ne (call $dispatch (i32.const 5) (i64.const 2)) (i64.const 2)) (then     
		;; 	(call $proc_exit (i32.const 2))
		;; ))

		;; (if (i64.ne (call $dispatch (i32.const 5) (i64.const 5)) (i64.const 5)) (then     
		;; 	(call $proc_exit (i32.const 2))
		;; ))
		
		;; (if (i64.ne (call $dispatch (i32.const 12) (i64.const 5)) (i64.const 120)) (then     
		;; 	(call $proc_exit (i32.const 2))
		;; ))
		
		;; (if (i64.ne (call $dispatch (i32.const 13) (i64.const 5)) (i64.const 8)) (then     
		;; 	(call $proc_exit (i32.const 2))
		;; ))
		
		;; (if (i64.ne (call $dispatch (i32.const 20) (i64.const 2)) (i64.const 2)) (then     
		;; 	(call $proc_exit (i32.const 2))
		;; ))
