...
__wasi_errno_t __wasi_args_get(void* wasi_context, char** argv, char* argv_buf) {
...
__wasi_errno_t __wasi_environ_get(void* wasi_context, char** environ, char* environ_buf) {
...
__wasi_errno_t __wasi_clock_res_get(void* wasi_context, __wasi_clockid_t id, __wasi_timestamp_t* retptr0) {
    return uvwasi_clock_res_get((uvwasi_t*)wasi_context, id, retptr0);
}

__wasi_errno_t __wasi_clock_time_get(void* wasi_context, __wasi_clockid_t id, __wasi_timestamp_t precision,
...
__wasi_errno_t __wasi_fd_close(void* wasi_context, __wasi_fd_t fd) {
    return uvwasi_fd_close((uvwasi_t*)wasi_context, fd);
}

__wasi_errno_t __wasi_fd_datasync(void* wasi_context, __wasi_fd_t fd) {
...
__wasi_errno_t __wasi_fd_fdstat_set_flags(void* wasi_context, __wasi_fd_t fd, __wasi_fdflags_t flags) {
...
__wasi_errno_t __wasi_fd_read(void* wasi_context, __wasi_fd_t fd, const __wasi_iovec_t* iovs, size_t iovs_len,
...
__wasi_errno_t __wasi_fd_seek(void* wasi_context, __wasi_fd_t fd, __wasi_filedelta_t offset, __wasi_whence_t whence,
...
__wasi_errno_t __wasi_fd_tell(void* wasi_context, __wasi_fd_t fd, __wasi_filesize_t* retptr0) {
    return uvwasi_fd_tell((uvwasi_t*)wasi_context, fd, retptr0);
}

__wasi_errno_t __wasi_fd_write(void* wasi_context, __wasi_fd_t fd, const __wasi_ciovec_t* iovs, size_t iovs_len,
                               __wasi_size_t* retptr0) {
...
__wasi_errno_t __wasi_path_filestat_get(void* wasi_context, __wasi_fd_t fd, __wasi_lookupflags_t flags,
...
__wasi_errno_t __wasi_path_filestat_set_times(void* wasi_context, __wasi_fd_t fd, __wasi_lookupflags_t flags,
                                              const char* path, __wasi_size_t path_len, __wasi_timestamp_t atim,
                                              __wasi_timestamp_t mtim, __wasi_fstflags_t fst_flags) {
    return __wasi_path_filestat_set_times((uvwasi_t*)wasi_context, fd, flags, path, path_len, atim, mtim, fst_flags);
}
...
__wasi_errno_t __wasi_path_open(void* wasi_context, __wasi_fd_t fd, __wasi_lookupflags_t dirflags, const char* path,
...
__wasi_errno_t __wasi_path_unlink_file(void* wasi_context, __wasi_fd_t fd, const char* path, __wasi_size_t path_len) {
...
_Noreturn void __wasi_proc_exit(void* wasi_context, __wasi_exitcode_t rval) {
...
__wasi_errno_t __wasi_sched_yield(void* wasi_context) {
    return uvwasi_sched_yield((uvwasi_t*)wasi_context);
}

__wasi_errno_t __wasi_random_get(void* wasi_context, uint8_t* buf, __wasi_size_t buf_len) {
