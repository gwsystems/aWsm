 ...
 */
wasi_errno_t wasi_snapshot_preview1_args_get(wasi_size_t argv_baseretptr, wasi_size_t argv_buf_baseretptr) {
 ...
 * @return WASI_ESUCCESS or WASI_EINVAL
 */
wasi_errno_t wasi_snapshot_preview1_environ_get(wasi_size_t environ_baseretptr, wasi_size_t environ_buf_baseretptr) {
    ...
    wasi_size_t*  environ_offset_vector = (wasi_size_t*)get_memory_ptr_for_runtime(environ_baseretptr,
                                                                                  sizeof(wasi_size_t)
                                                                                    * runtime_environ_len);
 ...
 * @param environ_buf_len_retptr - the offset where the resulting size of the environment variable data should be
 * written
 * @return status code
 */
wasi_errno_t
wasi_snapshot_preview1_environ_sizes_get(wasi_size_t environ_len_retptr, wasi_size_t environ_buf_len_retptr) {
    extern char** environ;
